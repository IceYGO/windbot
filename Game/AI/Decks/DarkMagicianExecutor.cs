...
namespace WindBot.Game.AI.Decks
{
    ...
    public class DarkMagicianExecutor : DefaultExecutor
    {
        public class CardId
        {
            public const int DarkMagician = 46986415;
        ...
        private bool DarkMagicalCircleeff()
        {
            ...
            {
                AI.SelectCard(AI.Utils.GetBestEnemyCardSkipUneffect());
                magician_sp = false;
            }
            return true;
        }
        ...
        private bool WonderWandeff()
        {
            ...
            {                
                if(Duel.Turn!=1)
                {
                    ...
                    AI.Utils.GetBestEnemyMonster(true) == null)
                        return false;
                    if (Duel.Phase == DuelPhase.Main1 && Enemy.GetSpellCountWithoutField() == 0 &&
        ...
        private bool Dracossacksp()
        {
            ...
            if (!soul_used && AI.Utils.IsOneEnemyBetterThanValue(2500, false) && 
        ...
        private bool Dracossackeff()
        {
            ...
            ClientCard target = AI.Utils.GetBestEnemyCardSkipUneffect();
            if (target != null)
            {
